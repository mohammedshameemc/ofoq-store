    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-2 w-full min-h-[385px]">
          ...
          <CarouselContent className="w-full relative h-full rounded-md">
            {column[0].module.slider?.banners.map(banner => (
              <CarouselItem
                ...
                <div className="w-full h-full rounded-md bg-[#C54000]"></div>
      ...
      <div className="flex flex-col sm:flex-row md:items-center lg:flex-col gap-2 h-full justify-between w-full">
        <div className="relative max-h-[200px] lg:h-full w-full overflow-hidden group">
          <div className="w-full h-full transform transition-transform duration-300 ease-in-out group-hover:scale-105 bg-[#271357]"></div>
          <div className="absolute top-5 left-5 md:top-10 md:left-10 flex flex-col items-start gap-5 text-white w-[190px]"></div>
        </div>
        <div className="relative max-h-[200px] lg:h-full w-full overflow-hidden group">
          <div className="w-full h-full transform transition-transform duration-300 ease-in-out group-hover:scale-105 bg-[#E14641]"></div>
        </div>
      </div>
    </div>
  );
